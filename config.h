...
static Key keys[] = {
  ...
  { MODKEY,                         XK_F9,           spawn,              SHCMD("volume toggle && updatewmbar") },
  { MODKEY,                         XK_F11,          spawn,              SHCMD("volume down && updatewmbar") },
  { MODKEY,                         XK_F12,          spawn,              SHCMD("volume up && updatewmbar") },
  { MODKEY|ControlMask,             XK_s,            spawn,              SHCMD("slock") },
  { MODKEY|ControlMask,             XK_b,            spawn,              SHCMD("updatewmbar") },
  ...
  { MODKEY,                         XK_F4,           spawn,              SHCMD("keyboard-toggle && updatewmbar") },
